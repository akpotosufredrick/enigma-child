...
if($wl_theme_options['blog_title'] !='') { ?>
	...
	<?php 	if ( have_posts()) :
			...
			<div class="col-md-4 col-sm-12 scrollimation  d2 pull-left">
			<div class="enigma_blog_thumb_wrapper">
				...
				<?php } ?>
				<?php the_excerpt( __( 'Mehr' , 'weblizar' ) ); ?>
				<a href="<?php the_permalink(); ?>" class="enigma_blog_read_btn"><i class="fa fa-plus-circle"></i><?php _e('Mehr','weblizar'); ?></a>
			...
			<div class="enigma_blog_thumb_wrapper">
				...
				<a href="#" class="enigma_blog_read_btn"><i class="fa fa-plus-circle"></i><?php _e('Mehr','weblizar'); ?></a>
				<div class="enigma_blog_thumb_footer">
					<ul class="enigma_blog_thumb_date">
